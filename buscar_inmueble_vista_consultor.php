	...
	<body>
		...
		<div class="container margen-superior">
			...
			<div class="row justify-content-center">
				<div class="col-lg-3">
					<a href="inmuebles_vista_consultor.php" title="Volver" class="text-info">Volver al listado de inmuebles</a>
				</div>
			</div>
						...
						echo "
							<table class='table table-bordered table-striped table-hover table-sm mt-4 text-center'>
								<thead class='bg-secondary tablasEncabezado'>
									<tr>
									<th colspan='4'>RESULTADOS DE BÚSQUEDA PARA EL FOLIO: <span class='text-warning'>".strtoupper($folio)."</span></th>
									</tr>
									<tr>
										<th>FOLIO</th>
										<th>INMUEBLE</th>
