	...
	<body>
		...
		<div class="container margen-superior">
			...
			<div class="row justify-content-center">
				<div class="col-lg-3">
					<a href="inmuebles_donaciones.php" title="Volver" class="text-info">Volver al listado de inmuebles</a>
				</div>
			</div>
		...
		<?php
			if (isset($_POST["folio"])) {
				...
				if (mysqli_num_rows($listadoInmuebles) > 0) {
					...
					echo "<p class='text-center lead text-primary mt-5'>No se obtuvieron resultados para el inmueble: <span class='text-danger'>".$folio."</span></p>";
				}
			}
		?>
